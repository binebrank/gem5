...
class O3_ARM_Neoverse_N1_FP_512(FUDesc):
    oplist = [ opdesc(opclass='simdadd', oplat=2), # asimd arithmetic basis (add & sub)
               ...
               opdesc(opclass='simdreduceadd', oplat=8), # sve reduction, arithmetic, s form (saddv) 
               opdesc(opclass='simdreducealu', oplat=9), # sve reduction, logical (andv)
...
class O3_ARM_Neoverse_N1_512(O3_ARM_Neoverse_N1):
